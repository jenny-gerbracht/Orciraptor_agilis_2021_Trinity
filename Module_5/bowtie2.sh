...
readdir="/srv/Jenny/Datasets/orciraptor/processed_github"
...
${moduledir}/BAM/Orciraptor_non-redundant.fas
...
for i in "${samples[@]}"; do
  ...
  salmon quant \
  -t ${mydir}/Module_3/transdecoder/Orciraptor_non-redundant.fas \
  -p 10 \
  -l A \
